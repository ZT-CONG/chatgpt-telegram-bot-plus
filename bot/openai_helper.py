...
GPT_3_MODELS = ("gpt-3.5-turbo", "gpt-3.5-turbo-0301", "gpt-3.5-turbo-0613", "gpt-3.5-turbo-1106", "gpt-3.5-turbo-0125")
GPT_ALL_MODELS = GPT_3_MODELS  

def default_max_tokens(model: str) -> int:
    """
    Returns default max tokens for supported models (only GPT-3.5 series).
    """
    if model in GPT_3_MODELS:
        if model in ("gpt-3.5-turbo-1106", "gpt-3.5-turbo-0125"):
            return 4096  
        return 2048  
    else:
        raise ValueError(f"Unsupported model for free-tier: {model}")
